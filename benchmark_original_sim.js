...
const simulateOriginalRender = (data, selectedMateria) => {
...
const runBenchmark = () => {
  ...
  // Warmup
  simulateOriginalRender(data, selectedMateria);
  ...
  console.log(`Tiempo para 100 renders (original, cambiando selectedMateria): ${end - start} ms`);
};
